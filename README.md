...
- Change the version of Loom you are using to `id "net.fabricmc.fabric-loom-no-remap" version "1.14.0-alpha.26"`
...
- Replace any mods using intermediary mappings (most Fabric mods) with unobfuscated builds, i.e. [Fabric API](https://github.com/FabricMC/fabric/releases/tag/0.138.3%2B1.21.11_unobfuscated).
